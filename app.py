...
model_path = os.path.join(os.path.dirname(__file__), "notebooks", "trained_model.sav")
scaler_path=os.path.join(os.path.dirname(__file__), "notebooks", "standardized_1.pkl")
